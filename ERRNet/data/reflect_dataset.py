...
class CEILDataset(BaseDataset):
    def __init__(
        ...
        ghost_max_shift=0,
        ghost_strength=0.35,
        random_reflection_pair=False,
    ):
        super(CEILDataset, self).__init__()
        self.size = size
        self.datadir = datadir
        self.enable_transforms = enable_transforms
        self.random_reflection_pair = random_reflection_pair
        ...
        self.syn_model = ReflectionSythesis_1(
            kernel_sizes=kernel_sizes or [11],
            low_sigma=low_sigma,
    ...
    def __getitem__(self, index):
        ...
        index_R = random.randrange(len(self.R_paths)) if self.random_reflection_pair else index % len(self.R_paths)
